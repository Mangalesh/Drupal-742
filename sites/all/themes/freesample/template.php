...
/**
 * @file
 * Contains theme override functions and process & preprocess functions for freesample
 */

// Auto-rebuild the theme registry during theme development.
if (theme_get_setting('freesample_clear_registry')) {
  // Rebuild .info data.
 ...
 */
function freesample_html_head_alter(&$head_elements) {
 ...
 */
function freesample_preprocess_search_block_form(&$vars) {
 ...
 */
function freesample_preprocess(&$vars, $hook) {
	
  $vars['freesample_path'] = base_path() . path_to_theme();
}

/**
 * Implements template_preprocess_html().
 */
function freesample_preprocess_html(&$vars) {
	
	
  $vars['doctype'] = _freesample_doctype();
  $vars['rdf'] = _freesample_rdf($vars);
  ...
  if (!$vars['is_front']) {
    ...
    if (isset($page_name)) {
      $vars['classes_array'][] = freesample_id_safe('page-' . $page_name);
    }

    $vars['classes_array'][] = freesample_id_safe('section-' . $section);
 ...
 */
function freesample_preprocess_page(&$vars) {
  ...
  if(!theme_get_setting('freesample_feed_icons')) {
    $vars['feed_icons'] = '';
  }
}
 ...
 */
function freesample_preprocess_maintenance_page(&$vars) {
  ...
  drupal_add_css(drupal_get_path('theme', 'freesample') . '/css/maintenance-page.css');
}
 ...
 */
function freesample_preprocess_node(&$vars) {
  // Striping class
 ...
 */
function freesample_preprocess_block(&$vars, $hook) {
 ...
 */
function freesample_menu_tree($vars) {
 ...
 */
function freesample_field__taxonomy_term_reference($vars) {
  $output = '';
 ...
 */
function freesample_breadcrumb($vars) {
 ...
 * @return bool
 */
function freesample_tabs_float() {
  $float = (bool) theme_get_setting('freesample_tabs_float');
  $float_node = (bool) theme_get_setting('freesample_tabs_node');
...
function freesample_id_safe($string) {
  // Strip accents
 ...
 * @ingroup themeable
 */
function freesample_menu_link(array $vars) {
  ...
  $element['#attributes']['class'][] = freesample_id_safe($element['#title']);
 ...
 */
function freesample_preprocess_menu_local_task(&$vars) {
 ...
 */
function freesample_menu_local_tasks(&$vars) {
